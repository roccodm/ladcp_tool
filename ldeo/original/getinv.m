...
% how much d_orig you want to smooth the ocean profile
ps=setdefv(ps,'smoofac',0);

% how much d_orig you want to restrict large shears on short vertical wavelengths
...
% d_orig you want up/down cast seperately then set to 1
...
%#!# but it does not d_orig anything
